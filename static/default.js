            ...
            let html = `<div id="widget_${i}" class="widget">
                            ...
                            <div class="widget__content">
                                ...
                                <div id="chronometre_${i}" class="widget__content_chronometre -hide">                                    
                                    <img src="/static/images/img-clock.png" alt="">
                                    <img id="button_left_${i}" class="button -left" src="/static/images/img-clock-button_left.png" alt="">
                                    <img id="button_right_${i}" class="button -right" src="/static/images/img-clock-button_right.png" alt="">
                                    <img id="button_up_${i}" class="button -up" src="/static/images/img-clock-button_up.png" alt="">
                                    <img id="needle_small_${i}"  class="needle -small" src="/static/images/img-clock-needle_small.png" alt="">
                                    <img id="needle_big_${i}" class="needle -big" src="/static/images/img-clock-needle_big.png" alt="">
                                </div>
                                ...
                                <div id="radio_${i}" class="widget__content_radio -hide">
                                    <img src="/static/images/img-radio.png">
                                    <img id="radio_play_${i}" src="/static/images/img-radio-play.png">
                                    <img id="radio_stop_${i}" src="/static/images/img-radio-stop.png">
                                    <img id="radio_baffle_left_${i}" src="/static/images/img-radio-baffle_left.png">
                                    <img id="radio_baffle_right_${i}" src="/static/images/img-radio-baffle_right.png">
...
window.addEventListener('resize', () => {
    ...
    else document.body.firstElementChild.firstElementChild.innerHTML = '<img id="dashboard_logo" src="/static/images/logo-cdev_camp-green.png" alt="logo"><h1>Dashboard</h1>'
...
function changeLogo (color) {
    ...
    dash_logo.setAttribute('src', `/static/images/logo-cdev_camp-${color}.png`)
}
...
document.getElementById('theme').addEventListener('change', () => {
    ...
    switch (document.getElementById('theme').value) {
        case 'blue': linkElement.setAttribute('href', '/static/css/theme-dark_blue.css');
            changeLogo('blue'); break;
        case 'red': linkElement.setAttribute('href', '/static/css/theme-dark_red.css');
            changeLogo('red'); break;
        default: linkElement.setAttribute('href', '/static/css/theme-default.css');
            changeLogo('green');
    }
...
function click(element, name) {
    ...
    element.setAttribute('src', `/static/images/img-clock-${name}-press.png`)
    setTimeout( () => {        
        element.removeAttribute('src')
        element.setAttribute('src', `/static/images/img-clock-${name}.png`)
    }, 100)
}
...
function writeMeteo(i, response) {
    if (response != 'Ville introuvable') {        
        ...
        if (res.weather[0].main == 'Clouds' && (res.weather[0].description == 'few clouds' || res.weather[0].description == 'scattered clouds')) {
            document.getElementById(`meteo_${i}`).style.backgroundImage = `url("/static/images/meteo-few_clouds.gif")`
        } else document.getElementById(`meteo_${i}`).style.backgroundImage = `url("/static/images/meteo-${res.weather[0].main.toLowerCase()}.gif")`
    }
}
